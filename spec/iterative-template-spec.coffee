QUnit.specify "iterative template", ->
  describe "iterative template", ->
    ...
    expected = '<div map-id="iterative"><h3>Grocery List</h3><div map-id="listItems"><div map-id="0"><span map-id="name">banana</span><span> - </span><span map-id="qty">all of them</span></div><div map-id="1"><span map-id="name">apples</span><span> - </span><span map-id="qty">2</span></div><div map-id="0"><span map-id="name">oranges</span><span> - </span><span map-id="qty">three</span></div></div></div>'
