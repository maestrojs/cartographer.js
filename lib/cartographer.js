    ...
    return function(instance, model, modelFqn, id, onElement) {
      ...
      if (template) {
        ...
        if (childrenToCreate && childrenToCreateCount > 0) {
          collection = !_.isString(val) && (val != null ? val.length : void 0) ? val : val != null ? val.items : void 0;
          ...
          if (collection && collectionCount) {
            ...
            return controls = (function() {
              ...
              for (_i = 0, _len = childrenToCreate.length; _i < _len; _i++) {
                ...
                _results2.push(createElement(instance, (element.id || !id || !model[id] ? val : model[id]), newFqn, void 0, onChildElement));
              }
              return _results2;
            })();
          }
