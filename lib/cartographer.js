...
Template = function(name) {
  ...
  buildCreateElement = function(element, elementId, elementFqn, childrenToCreate, templates) {
    ...
    return function(instance, model, modelFqn, id, onElement) {
      var children, collection, controls, createElement, factory, indx, list, newFqn, newId, onChildElement, outerList, template, val, _ref, _results;
        ...
        if (childrenToCreate && childrenToCreate.length > 0) {
          ...
          if (collection && collection.length) {
            ...
            self.factories[newFqn + "_add"] = function(newIndex, newModel) {
              var callback, childList, factory, onChildElement, _i, _len, _results;
            ...
            onChildElement = function(childElement) {
              ...
              if (list.length === childrenToCreate.length) {
                outerList.push(makeTag(tag, element, newFqn, newId, elementId !== void 0, list, model, instance));
                list = [];
                if (outerList.length === collection.length) {
                  return onElement(outerList);
                }
              }
            };
            _results = [];
