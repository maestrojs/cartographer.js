...
Cartographer = (function() {
  ...
  Cartographer.prototype.render = function(name, id, model, onMarkup, onError) {
    ...
    if (this.templates[name]) {
      ...
      return template.render(id, model, function(id, op, result) {
...
Template = (function() {
  ...
  Template.prototype.makeTag = function(tag, originalElement, fqn, id, hasId, val, model, templateInstance) {
    var alt, content, element, link, properties, self, _ref, _ref2, _ref3;
    self = this;
    properties = {};
    ...
    if (tag === "INPUT") {
      ...
      link = ((_ref2 = model[id]) != null ? _ref2.link : void 0) || model.link || originalElement.href;
      alt = ((_ref3 = model[id]) != null ? _ref3.alt : void 0) || model.alt || content || originalElement.alt;
      properties = $.extend(properties, {
        href: link,
        alt: alt
      });
